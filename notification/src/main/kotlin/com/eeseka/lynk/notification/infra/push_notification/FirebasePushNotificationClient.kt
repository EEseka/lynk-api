package com.eeseka.lynk.notification.infra.push_notification
...
class FirebasePushNotificationClient(
    ...
    fun initialize() {
        if (FirebaseApp.getApps().isNotEmpty()) {
            logger.info("Firebase Admin SDK is already initialized, leaving it alone")
            return
        }
                        ...
                        Platform.ANDROID -> {
                            setAndroidConfig(
                                AndroidConfig.builder()
                                    ...
                                    .setCollapseKey(notification.hangoutId.toString())
                                    .build()
                            )
                        }
                            ...
                            setApnsConfig(
                                ApnsConfig.builder()
                                    .setAps(
                                        Aps.builder()
                                            .setSound("default")
                                            .setThreadId(notification.hangoutId.toString())
                                            .build()
                                    )
                                    .build()
                            )
    ...
    private fun BatchResponse.toSendResult(
        ...
        logger.debug(
            ...
            succeeded.size, temporaryFailures.size, permanentFailures.size
        )
